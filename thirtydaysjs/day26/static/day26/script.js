                    ...
                    .then(data => {
                        ...
                        tarotCards.forEach(tarotCard => {
                            ...
                            newDiv.innerHTML = `<div class="tarot-card">
                                                    <img class="front-face" src="/static/day26/cards_png/${fileName}_line.png" alt="${name}">
                                                    <img class="back-face" src="/static/day26/cards_png/cover_line.png" alt="blank card">
                                                 </div>
                                                 <div class="card-info">
                                                    <h1>${title}</h1>
                                                    <p>${meaning}</p>
